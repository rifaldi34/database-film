...
<div class="container">
	...
	<?php while ($data=mysqli_fetch_array($sql_eksekusi)):?>
		...
		<div class="col-lg-3 col-md-4 col-6 mrg1">
			...
			<img class="img1" src='<?php echo $data['cover_film'] ?>'>
			<div class="text1">
				<table class="table1">
					<tr>
					...
					<tr>
						<td colspan='3'>
							<a class="editfilm" href='form_edit_film.php?id_film=<?php echo $data['id_film'] ?>'>Edit</a> | 
							<a class="hapusfilm" href='ui_hapus_film.php?id_film=<?php echo $data['id_film'] ?>'>Hapus</a>
						</td>
					</tr>
				</table>
			</div>
